...
mod database_impl {
    extern "C" {
        ...
        pub fn db_store_i64(scope: u64, table: u64, payer: u64, id: u64, data: *const crate::c_void, len: u32);
...
#[inline]
pub fn db_store_i64(scope: Name, table: Name, payer: Name, id: u64, data: *const crate::c_void, len: u32) {
    unsafe { database_impl::db_store_i64(scope.as_u64(), table.as_u64(), payer.as_u64(), id, data, len) }
}
